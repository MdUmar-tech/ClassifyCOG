...
plt.figure(figsize=(14, 14))  # Increase figure size to make the pie chart larger
plt.pie(MCCB_246["Frequency"], labels=MCCB_246["FunctionClass"], colors=palette, autopct='%1.1f%%', startangle=140, pctdistance=0.9)
plt.title("COG Function Classification", fontsize=16)
...
# Create the custom legend with smaller size
plt.legend(custom_legend_handles, custom_legend_labels, bbox_to_anchor=(1, 0.5), loc='center left', title="MMCC30 Function class", prop={'size': 11})  # Smaller size here
